...
const BookDetailedWindow = ({ book, tabLists, updateItem, addItemToListId, removeItemFromListId, closeDetails, refreshListsInApp }) => {

  return (
    <div className="detailed-window">
      <ItemToolbar item={book} lists={tabLists} updateItem={updateItem} addItemToListId={addItemToListId} removeItemFromListId={removeItemFromListId} closeDetails={closeDetails} refreshListsInApp={refreshListsInApp} />
