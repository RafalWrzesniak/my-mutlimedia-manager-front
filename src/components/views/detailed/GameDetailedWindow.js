...
const GameDetailedWindow = ({ game, tabLists, updateItem, addItemToListId, removeItemFromListId, closeDetails, refreshListsInApp }) => {
  return (
    <div className="detailed-window">
    <ItemToolbar item={game} lists={tabLists} updateItem={updateItem} addItemToListId={addItemToListId} removeItemFromListId={removeItemFromListId} closeDetails={closeDetails} refreshListsInApp={refreshListsInApp} />
